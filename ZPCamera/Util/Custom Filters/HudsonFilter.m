...
NSString *const kFWHudsonShaderString = SHADER_STRING
(
...
@implementation Filter5

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFWHudsonShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    Filter5 *filter = [[Filter5 alloc] init];
